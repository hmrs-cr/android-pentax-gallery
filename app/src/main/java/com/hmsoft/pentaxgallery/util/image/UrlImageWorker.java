 ...
 */
public abstract class UrlImageWorker {
    private static final String TAG = "UrlImageWorker";
    ...
    protected UrlImageWorker(Context context) {
    ...
    /**
     * Adds an {@link ImageCache} to this {@link UrlImageWorker} to handle disk and memory bitmap
     * caching.
     ...
     *
     * @param url The url to identify which image to process, as provided by
     ...
     * Returns false if the work in progress deals with the same url. The work is not
