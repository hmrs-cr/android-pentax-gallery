...
public final class Logger {
    ...
    private static final String APP_TAG = "PTXGAL:";
	...
	public static void log2file(String tag, String msg, String fileName, Throwable e) {
		...
		try {
			if(sLogsFolder == null) {
				if((sLogsFolder = MyApplication.ApplicationContext.getExternalFilesDir(LOGS_FOLDER)) == null) {
                    sLogsFolder = MyApplication.ApplicationContext.getFilesDir();
                }
			}
